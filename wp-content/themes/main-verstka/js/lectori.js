...
if (xml.status == 200) {
    ...
    img[6].innerHTML = db.Olga.img;
    img[7].innerHTML = db.Regina.img;
    img[8].innerHTML = db.Sergey.img;
    img[9].innerHTML = db.Varvara.img;
    ...
    nameParse[6].innerHTML = db.Olga.name;
    nameParse[7].innerHTML = db.Regina.name;
    nameParse[8].innerHTML = db.Sergey.name;
    nameParse[9].innerHTML = db.Varvara.name;
    ...
    desc[6].innerHTML = db.Olga.description;
    desc[7].innerHTML = db.Regina.description;
    desc[8].innerHTML = db.Sergey.description;
    desc[9].innerHTML = db.Varvara.description;
}